...
const Login = ({ setIsAuth }) => {
    ...
    return (
        <div className="tw-min-h-screen tw-bg-slate-950 tw-flex tw-items-center tw-justify-center tw-p-6">
            <div className="tw-w-full tw-max-w-md tw-bg-white/5 tw-backdrop-blur-xl tw-border tw-border-white/10 tw-rounded-3xl tw-overflow-hidden tw-shadow-2xl">

                {/* Header */}
                <div className="tw-px-8 tw-pt-10 tw-text-center">
                    <div className="tw-flex tw-justify-center tw-mb-4">
                        <div className="tw-w-16 tw-h-16 tw-rounded-2xl tw-bg-white/10 tw-flex tw-items-center tw-justify-center">
                            <svg
                            ...
                            >
                                <path
                                    ...
                                    d="M8 3v10M12 3v10m4-10v10M5 21h14"
                                />
                            </svg>
                        </div>
                    </div>
                    ...
                    <form onSubmit={gestionarLogin} className="tw-space-y-6">
                        ...
                        <div className="tw-space-y-2">
                            <div className="tw-flex tw-justify-between tw-items-center">
                                ...
                                <a
                                    href="#"
                                    className="tw-text-xs tw-text-slate-500 hover:tw-text-white tw-transition-colors"
                                >
                            ...
                            <label className="tw-flex tw-items-center tw-gap-3 tw-cursor-pointer tw-group">
                                <div className="tw-relative">
                                    ...
                                    <div className="tw-absolute tw-inset-0 tw-flex tw-items-center tw-justify-center tw-opacity-0 peer-checked:tw-opacity-100 tw-transition-opacity">
                                        <svg
                                            className="tw-w-3 tw-h-3 tw-text-slate-950"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke="currentColor"
                                            strokeWidth="4"
                                ...
                                <span className="tw-text-sm tw-text-slate-400 group-hover:tw-text-slate-300 tw-transition-colors">
                                    Recordar sesión
                                </span>
                            </label>
                        </div>
                        ...
                        <p className="tw-text-center tw-text-sm tw-text-slate-500">
                            ...
                            <a
                                href="#"
                                className="tw-text-white tw-font-medium hover:tw-underline"
                            >
